package se.sics.gvod.simulator.croupier.main;
...
public class Main {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        if (numPub < 1) {
            System.err.println("You must have >0 public nodes");
            System.exit(1);
        }        
        int numPriv = (int) Double.parseDouble(args[3]);
        if (numPriv < 1) {
            System.err.println("You must have >0 private nodes");
            System.exit(1);
        }
