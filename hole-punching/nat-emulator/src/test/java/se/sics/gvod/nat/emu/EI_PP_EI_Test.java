...
public class EI_PP_EI_Test
    ...
    private static final Logger logger = LoggerFactory.getLogger(EI_PP_EI_Test.class);
     ...
     */
    public EI_PP_EI_Test(String testName) {
        super(testName);
    }
    ...
    public static Test suite() {
        return new TestSuite(EI_PP_EI_Test.class);
    }

    public static void setTestObj(EI_PP_EI_Test testObj) {
    ...
    public static class TestEmulatorComponent extends ComponentDefinition {
        ...
        private static EI_PP_EI_Test testObj = null;
        ...
        public Handler<Start> handleStart = new Handler<Start>() {
            ...
            public void handle(Start event) {
                ...
                trigger(new TestMsgId(
                        ...
                        emulator.getPositive(VodNetwork.class));
                trigger(new TestMsgId(
                        ToVodAddr.systemAddr(new Address(dest3, dest3Port, dest3Id)), 
                        ToVodAddr.systemAddr(new Address(natIP, src1Port, 10)), 
                        msgTimeout2.getTimeoutId()), 
                        emulator.getNegative(VodNetwork.class));
        ...
        private Handler<TestMsgId> handleUpperMessage = new Handler<TestMsgId>() {
            ...
            public void handle(TestMsgId event) {
                ...
                if (event.getSource().getIp().equals(dest3)
                        && event.getDestination().getIp().equals(src1)) {
                    incomingMsgs--;
                    if (incomingMsgs == 0) {
                        testObj.pass();
                    }
        ...
        private Handler<TestMsgId> handleLowerMessage = new Handler<TestMsgId>() {
            ...
            public void handle(TestMsgId event) {
                ...
                if (event.getSource().getIp().equals(testObj.natIP)
                        && event.getSource().getPort() == testObj.src1Port) {
                    testObj.incomingMsgs--;
                    if (testObj.incomingMsgs == 0) {
                        testObj.pass();
                    }
                } else {
                    testObj.fail(true);
    ...
    public void testApp() {
        ...
        try {
            EI_PP_EI_Test.semaphore.acquire(EVENT_COUNT);
