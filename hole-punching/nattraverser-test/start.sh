...
#ssh $USER@cloud4.sics.se "cd hpServer ; killall java ; ./run.sh false 1 0 109.69.8.203 true"
#ssh root@109.69.12.17 "cd hpServer ; killall java ; ./run.sh false 3 0 cloud4.sics.se true"
