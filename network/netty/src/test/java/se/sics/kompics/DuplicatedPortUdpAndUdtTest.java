...
/**
 * Try to bind to a port already used by UDT.
 *
 * @author Steffen Grohsschmiedt
 */
public class DuplicatedPortUdpAndUdtTest extends TestCase {
	 ...
	 */
	public DuplicatedPortUdpAndUdtTest(String testName) {
		super(testName);
	...
	public static Test suite() {
		return new TestSuite(DuplicatedPortUdpAndUdtTest.class);
	}

	public static void setTestObj(DuplicatedPortUdpAndUdtTest testObj) {
	...
	public static class TestStClientComponent extends ComponentDefinition {
		...
		private static DuplicatedPortUdpAndUdtTest testObj = null;
	...
	private void runInstance() {
		...
		try {
			DuplicatedPortUdpAndUdtTest.semaphore.acquire(EVENT_COUNT);
	...
	public void pass() {
		DuplicatedPortUdpAndUdtTest.semaphore.release();
	}
